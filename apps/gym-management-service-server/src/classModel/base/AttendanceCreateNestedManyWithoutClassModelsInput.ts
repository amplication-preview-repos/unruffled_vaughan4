...
@InputType()
class AttendanceCreateNestedManyWithoutClassModelsInput {
...
export { AttendanceCreateNestedManyWithoutClassModelsInput as AttendanceCreateNestedManyWithoutClassModelsInput };
