...
@InputType()
class MemberCreateNestedManyWithoutSubscriptionsInput {
...
export { MemberCreateNestedManyWithoutSubscriptionsInput as MemberCreateNestedManyWithoutSubscriptionsInput };
